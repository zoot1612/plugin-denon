...
------
  ...
  if ui7Check == "true" then
    ...
    row_start = 0
	  ...
	  outf:write( '{\n' )
	  outf:write( '	"default_icon": "https://github.com/zoot1612/plugin-denon/blob/master/av_receiver_default.png",\n' )
	  outf:write( '    "state_icons": [\n' )
	  outf:write( '        {\n' )
	  outf:write( '            "img": "https://github.com/zoot1612/plugin-denon/blob/master/av_receiver_standby.png",\n' )
	  ...
	  outf:write( '        },\n' )
	  outf:write( '        {\n' )
	  outf:write( '            "img": "https://github.com/zoot1612/plugin-denon/blob/master/av_receiver_on.png",\n' )
	  outf:write( '            "conditions": [\n' )
	  outf:write( '                {\n' )
	  outf:write( '                    "service": "urn:upnp-org:serviceId:SwitchPower1",\n' )
	  outf:write( '                    "variable": "Status",\n' )
