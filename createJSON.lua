...
------------------------------------------------------------------------------------------
function create_static_json(input_table, avr_dev)
...
------
  ...
  outf:write( '				"Service": "urn:denon-com:serviceId:Receiver1",\n' )
	...
	outf:write( '					"Command": {\n' )
	outf:write( '						"Service": "urn:denon-com:serviceId:Receiver1",\n' )
	outf:write( '						"Action": "SetVolumeTarget",\n' )
	outf:write( '						"Parameters": [{\n' )
	outf:write( '							"Name": "newTargetValue",\n' )
	outf:write( '							"ID": "newTargetValue"\n' )
	outf:write( '						}]\n' )
...
--[[
	...
	for k, v in ipairs(input_table) do
		...
		local column_num = (k%3 == 0) and (3-1) or ((k%3)-1)
		local left = (column_num*(button_width+spacing))+column_start
		local top = ((math.ceil(k/3) == 1)) and row_start or ((math.ceil(k/3)) * row_start)
...
------
	...
	outf:write( '					"serviceId": "urn:denon-com:serviceId:Receiver1",\n' )
	outf:write( '					"action": "SetVolumeTarget",\n' )
